...
describe('Simulations', () => {
  ...
  describe('Mortek Guard Swords', () => {
    ...
    testSimulation(unit, [8.806, 8.806, 7.338, 5.870, 4.403, 2.935]);
  });
  ...
  describe('Hearthguard Berzerkers Broadaxes', () => {
    ...
    testSimulation(unit, [36.444, 36.444, 30.37, 24.296, 18.222, 12.148]);
  });
  ...
  describe('Hearthguard Berzerkers Poleaxes', () => {
    ...
    testSimulation(unit, [31.889, 28.852, 25.815, 22.778, 19.741, 16.704]);
  });
  ...
  describe('Necropolis Stalkers Swords /w No Aspect', () => {
    ...
    testSimulation(unit, [6.667, 6.667, 5.556, 4.444, 3.333, 2.222]);
  });
  ...
  describe('Necropolis Stalkers Swords /w Precision Aspect', () => {
    ...
    testSimulation(unit, [13.333, 13.333, 13.333, 11.111, 8.889, 6.667]);
  });
  ...
  describe('Necropolis Stalkers GS + S /w No Aspect', () => {
    ...
    testSimulation(unit, [6.444, 6.444, 5.704, 4.630, 3.556, 2.481]);
  });
  ...
  describe('Necropolis Stalkers GS + S /w Precision Aspect', () => {
    ...
    testSimulation(unit, [11.889, 11.889, 11.889, 10.407, 8.426, 6.444]);
  });
  ...
  describe('Gotrek Gurnisson', () => {
    const unit = new Unit('Gotrek Gurnisson', [
      new WeaponProfile(1, 6, 3, 3, 2, 3, [
        ...
        new m.MORTAL_WOUNDS({
          characteristic: C.TO_HIT, on: 6, mortalWounds: D6, unmodified: true, inAddition: true,
        }),
      ]),
    ]);
    testSimulation(unit, [18.889, 18.889, 18.889, 16.519, 14.148, 11.778]);
  });
  ...
  describe('Spirit Hosts', () => {
    const unit = new Unit('Spirit Hosts', [
      new WeaponProfile(3, 6, 5, 4, 0, 1, [
        new m.MORTAL_WOUNDS({
          characteristic: C.TO_HIT, on: 6, mortalWounds: 1, inAddition: false, unmodified: true,
        }),
      ]),
    ]);
    testSimulation(unit, [4.5, 4.25, 4, 3.75, 3.5, 3.25]);
  });
  ...
  describe('Kurnoth Hunters Swords', () => {
    ...
    testSimulation(unit, [13.000, 13.000, 11.074, 9.148, 7.222, 5.296]);
  });
  ...
  describe('Plague Monks (pre Dec 2019 FAQ)', () => {
    ...
    testSimulation(unit, [20.000, 17.778, 14.444, 11.111, 7.778, 4.444]);
  });
  ...
  describe('Rattling Gunners', () => {
    ...
    testSimulation(unit, [1.75, 1.75, 1.458, 1.167, 0.875, 0.583]);
  });
});
