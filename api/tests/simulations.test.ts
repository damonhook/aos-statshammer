...
describe('Simulations', () => {
  ...
  describe('Mortek Guard Swords', () => {
    ...
    testSimulation(unit, [8.806, 8.806, 7.338, 5.87, 4.403, 2.935]);
  });
  ...
  describe('Necropolis Stalkers GS + S /w No Aspect', () => {
    ...
    testSimulation(unit, [6.444, 6.444, 5.704, 4.63, 3.556, 2.481]);
  });
  ...
  describe('Kurnoth Hunters Swords', () => {
    ...
    testSimulation(unit, [13.0, 13.0, 11.074, 9.148, 7.222, 5.296]);
  });
  ...
  describe('Plague Monks (pre Dec 2019 FAQ)', () => {
    ...
    testSimulation(unit, [20.0, 17.778, 14.444, 11.111, 7.778, 4.444]);
  });
